...
Scaffolds a new CDK stack. Includes stack class extending `@bepower/bep-cdk-lib` base, stage integration, test file, and proper naming conventions.
...
| `new-stack` | CDK projects using `@bepower/bep-cdk-lib` |
